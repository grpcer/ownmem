...
const DEFAULT_CORPUS = path.join(SCRIPT_DIR, 'corpus.json');
const DEFAULT_SUPPLEMENT = path.join(SCRIPT_DIR, 'supplement.json');
...
function usage() {
  return `Usage: npm run benchmark [-- options] (node benchmarks/public-benchmark.mjs)
