...
[CONTRIBUTING.md](../../.github/CONTRIBUTING.md): den Standard-Recall deterministisch,
...
OwnMem ist unter Apache-2.0 lizenziert. Lies `docs/PRIVACY.md`, `.github/SECURITY.md` und
`docs/RELEASE.md`, bevor du Artefakte teilst oder ein Release veröffentlichst.
