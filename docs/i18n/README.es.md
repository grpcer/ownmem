...
[CONTRIBUTING.md](../../.github/CONTRIBUTING.md) para las reglas básicas: mantener el
...
seguridad van por [SECURITY.md](../../.github/SECURITY.md).
...
OwnMem se licencia bajo Apache-2.0. Consulta `docs/PRIVACY.md`, `.github/SECURITY.md` y
`docs/RELEASE.md` antes de compartir artefactos o publicar una versión.
