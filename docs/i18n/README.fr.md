...
[CONTRIBUTING.md](../../.github/CONTRIBUTING.md) pour les règles de base : garder la
...
sécurité passent par [SECURITY.md](../../.github/SECURITY.md).
...
OwnMem est sous licence Apache-2.0. Consultez `docs/PRIVACY.md`, `.github/SECURITY.md` et
`docs/RELEASE.md` avant de partager des artefacts ou de publier une version.
