...
function parseArgs(args) {
  const options = { root: process.cwd(), memoryDir: null, writeLock: false, strictWorkingTree: false, json: false, observability: true };
  for (let index = 0; index < args.length; index += 1) {
    ...
    else if (argument === '--strict-working-tree') options.strictWorkingTree = true;
...
Options:
  ...
  --strict-working-tree  Reject uncommitted memory topic sources
