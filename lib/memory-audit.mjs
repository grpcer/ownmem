...
export function auditPlatformContract(platform) {
  ...
  return {
    ...
    // Argv for `executable`, not a PATH lookup: resolving the `ownmem` bin name is exactly what
    // shell_required: false rules out, and on Windows the npm shim is a .cmd that needs one.
