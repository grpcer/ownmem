 ...
 *
 * They live apart from either consumer for one reason: the daily package and the live report both
 * reduce the same events to counts, so a second definition of "attempt", "abstain rate" or "P95"
 * would produce two numbers carrying one name. One definition, imported by both.
 */
