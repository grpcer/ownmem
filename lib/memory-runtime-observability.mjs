...
const ABSTAIN_REASONS = new Set(['no-trusted-candidate', 'below-threshold', 'budget-empty', 'all-candidates-excluded']);
...
export function createMemoryRuntimeObserver(options = {}) {
  ...
  return {
    recordRecall({ runtime, query, envelope, metrics, execution } = {}) {
