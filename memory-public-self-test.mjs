...
import { runPublicBenchmark } from './memory-public-benchmark.mjs';
import { runMultilingualTokenizerSelfTest } from './memory-tokenizer-multilingual-self-test.mjs';

const PACKAGE_ROOT = path.dirname(fileURLToPath(import.meta.url));
const ENTRY = path.join(PACKAGE_ROOT, 'memory.mjs');
